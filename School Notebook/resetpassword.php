...
<body>
    ...
    <form class="signin">
     ...
     <div class="input-group">
         ...
         <input class="input-field" type="text" placeholder="Username" name="username" value="User Name"> 
     </div>
     <div class="input-group">
     ...
     <div class="input-group">
         ...
         <input class="input-field" type="password" placeholder="Old Password"name="password_1"> 
     </div>
     <div class="input-group">
         <!-- <label for="">Confirm Password</label> -->
         <input class="input-field" type="password" placeholder="New password"name="password_2"> 
     </div>
     <div class="input-group">
